...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[8rem] overflow-hidden rounded-2xl bg-white/50 p-1 text-neutral-950 shadow-[0_0_20px_-8px_rgba(0,0,0,0.25)] backdrop-blur-3xl dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50',
